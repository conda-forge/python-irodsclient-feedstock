...
Once the `conda-forge` channel has been enabled, `python-irodsclient` can be installed with `conda`:
...
```
mamba install python-irodsclient
```

It is possible to list all of the versions of `python-irodsclient` available on your platform with `conda`:
...
```
mamba search python-irodsclient --channel conda-forge
```
...
mamba repoquery search python-irodsclient --channel conda-forge

# List packages depending on `python-irodsclient`:
mamba repoquery whoneeds python-irodsclient --channel conda-forge

# List dependencies of `python-irodsclient`:
mamba repoquery depends python-irodsclient --channel conda-forge
```
